...
{ 
	...
	if($validate->validate() && count($stat)==0)
	{
		...
		$aryData=array(	
			...
			$flgIn1 = $db->insertAry("gallery",$aryData);
...
{ 
	...
	{ 
		...
		$aryData=array(	
				...
				$flgIn = $db->updateAry("gallery", $aryData , "where id='".$_GET['id']."' ");
...
elseif(($_REQUEST['action']=='delete'))
{
	...
	$flgIn1 = $db->delete("gallery","where id='".$_GET['id']."' ");			
...
<div id="wrapper">
  ...
  <div class="content-page">
    ...
    <div class="content">
      <div class="container">
		...
		<a href="<?php echo $FileName; ?>?action=add"  class="btn btn-default" style="float:right">Add New Record</a>
			...
			$aryDetail=$db->getRow("select * from  gallery where id='".$_GET['id']."'");	
					?>
            <div class="card-box">
              <form role="form" action="" method="post" enctype="multipart/form-data">
                <div>
	...
	$GetEmailId=$db->getRow("select * from  gallery where id='".$_GET['id']."'");
	?>
            <div class="card-box">
              <section>
          ...
          <div class="card-box">
            <table id="datatable" class="table table-striped table-bordered">
              ...
              <tbody>
                <?php
		$aryList=$db->getRows("select * from gallery  order by id desc");
