...
<div id="wrapper">
  ...
  <div class="content-page">
    ...
    <div class="content">
      <div class="container">
		...
		<a href="<?php echo $FileName; ?>?action=add"  class="btn btn-default" style="float:right">Add New Record</a>
                ...
                <div>
                  <section>
                    ...
                    <div class="form-group clearfix">
                      ...
                      <div class="col-lg-10">
                        <input type="text" class="form-control required" id="title" name="title" value="<?php echo $_POST['title']; ?>">
                      </div>
                    </div>
					...
					<div class="form-group clearfix">
                      ...
                      <div class="col-lg-10">
                        <input type="file" class="form-control required" id="image" name="image" value="<?php echo $_POST['image']; ?>">
                      </div>
                    </div>
			...
			$aryDetail=$db->getRow("select * from  service where id='".$_GET['id']."'");	
					?>
            <div class="card-box">
              <form role="form" action="" method="post" enctype="multipart/form-data">
                <div>
                  <section>
                    ...
                    <div class="form-group clearfix">
                      <label class="col-lg-2 control-label " for="userName">Title</label>
                      <div class="col-lg-10">
                        <input type="text" class="form-control required" id="title" name="title" value="<?php echo $aryDetail['title']; ?>">
                      </div>
                    </div>
	...
	$GetEmailId=$db->getRow("select * from  service where id='".$_GET['id']."'");
	?>
            <div class="card-box">
              <section>
          ...
          <div class="card-box">
            <table id="datatable" class="table table-striped table-bordered">
              ...
              <tbody>
                <?php
		$aryList=$db->getRows("select * from service  order by id desc");
