                                ...
                                <div class="panel-body">
                                    <form role="form" action="" method="post">
                                        <div class="form-group clearfix">
                                            <label class="control-label" for="current_pass">Current Password <span class="text-danger">*</span></label>
                                            <div class="input-group">
                                                <input type="password" class="form-control required" id="current_pass" name="current_pass" 
                                                       value="<?= e($_POST['current_pass'] ?? '') ?>" autocomplete="off">
                                                <span class="fa fa-eye-slash toggle-password" data-target="current_pass"></span>
                                            </div>
                                        </div>

                                        <div class="form-group clearfix">
                                            <label class="control-label" for="new_pass">New Password <span class="text-danger">*</span></label>
                                            <div class="input-group">
                                                <input type="password" class="form-control required" id="new_pass" name="new_pass" 
                                                       value="<?= e($_POST['new_pass'] ?? '') ?>" autocomplete="off">
                                        ...
                                        <div class="form-group clearfix">
                                            <label class="control-label" for="renew_pass">Confirm New Password <span class="text-danger">*</span></label>
                                            <div class="input-group">
                                                <input type="password" class="form-control required" id="renew_pass" name="renew_pass" 
                                                       value="<?= e($_POST['renew_pass'] ?? '') ?>" autocomplete="off">
