                  ...
                  <div class="zawq Wizard-a1">
                    <table id="example" class="display" >
                      ...
                      <tbody>
						...
						$iLeagueId=array();
$aryDetail=$db->getRows("select * from student_guardian where parent_id='".$studentdata['parent_id']."' "); 
foreach($aryDetail as $iList) {
	...
	//array_push($iLeagueId,$iManageStudents['student_id']); 
                        ...
                        <tr>
                          ...
                          <td class="sectsab <?php if($iManageStudents['randomid']==$_GET['randomid']) { echo "active"; } ?>"><a href="<?php echo $FileName; ?>?action=input_score&randomid=<?php echo $iManageStudents['randomid'] ?>">
                            <ul>
						...
						if($iManageStudents['picture']=='') { ?>
                                ...
                                <?php echo $iManageStudents['student_id'] ?> </li>
                            </ul>
                            </a></td>
                        </tr>
                        <?php }  } ?>
              ...
              <form action="" method="post">
                ...
                <a href="<?php echo PARENT_URL; ?>term_result_pdf_old.php?randomid=<?php echo $_GET['randomid']; ?>&session=<?php echo $_POST['session']; ?>&term_id=<?php echo $_POST['term_id']; ?>&assesments=<?php echo $assesments; ?>" class="printer_pdf" target="_blank">Print Report Sheet</a> </span>
              </form>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <?php
										...
										{ 
										$count=$count+1;
										$score=$db->getRow("select score , student_id from input_score_class_teacher where class_id = '" .$currentStudent['class']. "' and assesment_id='".$Val."' and student_id='".$currentStudent['id']."' and subject_id='".$Ilist['id']."' and  session_id='".$_POST['session']."' and term_id='".$_POST['term_id']."' and create_by_userid='".$studentdata['create_by_userid']."'");
										?>
                          <td><?php echo $score['score']; ?>---------------<?php echo $score['student_id']; ?></td>
                          <?php $sum=$score['score'];
										${"d" . $Ilist['id']}+=$sum;
										?>
                          <?php } 
                        ...
                        <?php } ?>
                         <input type="text" value="<?php echo $score['student_id']; ?>" >
                         
                         
<?php echo PARENT_URL; ?>term_result_pdf_old.php?randomid=<?php echo $_GET['randomid']; ?>&session=<?php echo $_POST['session']; ?>&term_id=<?php echo $_POST['term_id']; ?>&assesments=<?php echo $assesments; ?>                         
