...
<?php include('inc.sideleft.php'); ?>
    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="col-md-12   col-xm-12">
                ...
                <label>Ass:</label>
                <?php $assesment=$db->getRows("select * from school_assessment where create_by_userid='".$create_by_userid."' and class_id='".$aryList['id']."' order by id desc "); 
        ...
        ?>
                      <a href="<?php echo SKOOL_URL; ?>class_teacher_subject_result_pdf.php?randomid=<?php echo $_GET['randomid']; ?>&subject=<?php echo $_POST['subject']; ?>&session=<?php echo $_POST['session']; ?>&term_id=<?php echo $_POST['term_id']; ?>&assesments=<?php echo $assesments; ?>" class="printer_pdf" target="blank"> Print Subject Result </a>
                      <?php } ?>
                      &nbsp;
                      <?php if($_POST['subject']==''){ ?>
                      <button type="submit" name="pdf" class="printer_pdf"> Print Empty Score Sheet </button>
                      <?php } else {?>
                      <a href="<?php echo SKOOL_URL; ?>class_teacher_subject_empty_result_pdf.php?randomid=<?php echo $_GET['randomid']; ?>&subject=<?php echo $_POST['subject']; ?>&session=<?php echo $_POST['session']; ?>&term_id=<?php echo $_POST['term_id']; ?>&assesments=<?php echo $assesments; ?>" class="printer_pdf" target="blank"> Print Empty Score Sheet </a>
                      <?php } ?>
                      </span>
              </form>
 ...
 <?php 	echo  $gradding=$db->getVal("select grade from school_grade where create_by_userid='".$create_by_userid."'  and minimum_number <= ".$grandTotal." and maximum_number >= ".$grandTotal."");?>
 </td>
                                <td id="<?php echo $a; ?>"></td>
                              </tr>
                        <?php   }   ?>
...
?>
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <td><span>Highest Average in Class:
                          <?php $mss= max($highLow); echo round($mss,2); ?>
                          </span></td>
                        <td><span>Lowest Average in Class:
                          <?php $mnn= min($highLow);  echo round($mnn,2);  ?>
                          </span></td>
                      </tr>
                          </table>
                    <?php } ?>
