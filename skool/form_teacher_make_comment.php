...
$FileName = 'form_teacher_make_comment.php';
...
<div class="zasw1">
				...
				$aryList=$db->getRows("select * from manage_student where randomid='".$_GET['randomid']."'");
						foreach($aryList as $iList)
							{
							$aryList11=$db->getRow("select * from form_teacher_make_comment where randomid='".$_GET['randomid']."'");
							 ?>
                                        <tr>
