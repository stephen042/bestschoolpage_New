...
$pageTitle = 'Cumulative Board Result';
$Filename = 'cumulative_board_result.php';
?>
<!DOCTYPE html>
<html>
<head>
...
<tbody>
<?php $aryDetail = $db->getRows("select * from input_score_subject_teacher where create_by_userid='".$create_by_userid."'");
...
<label for="gwt-uid-8">CA3 (40%)</label></span>
            ...
            <table  class="table table-striped table-bordered">
                ...
                <?php
                $aryList = $db->getRows("select * from input_score_subject_teacher where class_id = '" .$_GET['class']. "' and create_by_userid='".$create_by_userid."'");
