...
$Filename = 'class_teacher_sub_results.php';
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="row">
<div class="col-sm-12">
<h4 class="page-title">SUBJECT RESULTS</h4>
</div>
</div>
<!-- Basic Form Wizard -->
<div class="row">
...
<tbody>
	...
	<?php  $getClass=$db->getRows("select * from school_class order by id desc "); 
	foreach($getClass as $iList)  {
	...
	<span style="color:#000;">
	<?php
	echo $db->getVal("select session from school_session where id='".$iList['session_id']."' "); 
	?>
	 </span>
	</li>
	</a>
...
<select class="gwt-Button" name="allSubject">
<option value="">--select Subject--</option>
<?php
 $getSub=$db->getRows("select * from 	school_subject order by id desc "); 
foreach($getSub as $iList)  {
 ?>
<option value=""><?php echo $iList['subject']; ?></option>
<?php } ?>
</select>
...
<td align="left" style="vertical-align: top;">
<button type="button" class="gwt-Button" style="">Print Subject Results</button></td>
<td align="left" style="vertical-align: top;">
<button type="button" class="gwt-Button">Print Empty Score Sheets</button></td>
</tr>
</tbody>
</table>
...
<tr>
<td>
<div class="boldInfoLabel">First Term, 2018/2019 Session</div></td>
</tr>
<tr><td><div class="infoLabel">Class: JSS1 A</div></td></tr>						
                                ...
                                <table  class="table table-striped table-bordered">
									...
									<td><div class="clickableElement" style="width: 100%;">AA/001</div></td>
									<td><div class="resultDataCell" style="width: 100%;">John</div></td>
									<td><div class="resultDataCell" style="width: 100%;">James</div></td>
									<td><div class="resultDataCell" style="width: 100%;"></div></td>
									<td><div class="gwt-Label" style="width: 100%;">90</div></td>
									<td><div class="gwt-Label" style="width: 100%;">47</div></td>
									<td><div class="gwt-Label" style="width: 100%;">0</div></td>
									<td><div class="gwt-Label" style="width: 100%;">48</div></td>
									<td><div class="gwt-Label" style="width: 100%;">63</div></td>
									<td><div class="gwt-Label" style="width: 100%;">77</div></td>
