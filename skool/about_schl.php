...
'status'     	 	         		 =>	$_POST['status'],	
					...
					$flgIn1 = $db->insertAry("about_schl",$aryData);
...
'status'     	 	         		 =>	$_POST['status'],	
					...
					$flgIn = $db->updateAry("about_schl", $aryData , "where id='".$_GET['id']."' ");
		...
		elseif(($_REQUEST['action']=='delete'))
		{
			...
			$flgIn1 = $db->delete("about_schl","where id='".$_GET['id']."' ");			
                ...
                <div>
                  <section>
                    ...
                    <div class="form-group clearfix">
                      ...
                      <div class="col-lg-10">
                        <input type="text" class="form-control" id="short_description" name="short_description" value="<?php echo $_POST['short_description']; ?>">
                      </div>
                    </div>
                ...
                <div>
                  <section>
                    ...
                    <div class="form-group clearfix">
                      <label class="col-lg-2 control-label " for="userName">Short Description</label>
                      <div class="col-lg-10">
                        <input type="text" class="form-control" id="short_description" name="short_description" value="<?php echo $aryDetail['short_description']; ?>">
                      </div>
                    </div>
	...
	?>
            <div class="card-box">
              <section>
                ...
                <div class="form-group clearfix">
                  <label class="col-lg-2 control-label " for="userName">Short Description :</label>
                  <?php echo $GetEmailId['short_description']; ?> </div>
          ...
          <div class="card-box">
            <table id="datatable" class="table table-striped table-bordered">
              ...
              <tbody>
                <?php
		$aryList=$db->getRows("select * from about_schl  order by id desc");
