...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .traits-container { max-width: 1400px; margin: 0 auto; padding: 20px; }
                    ...
                    <div class="ratings-panel">
                        ...
                        <?php if (!empty($selectedClass)): ?>
                            ...
                            <div class="filter-card">
                                <form method="GET" action="" id="filterForm">
                                    ...
                                    <div class="filter-grid">
                                        ...
                                        <div class="filter-group">
                                            <label><i class="fa fa-heart"></i> AFFECTIVE TRAIT</label>
                            ...
                            <?php elseif (!empty($selectedSession) && !empty($selectedTerm) && empty($selectedTrait)): ?>
                                <div class="alert alert-info">
                                    <i class="fa fa-heart"></i> Please select an affective trait to continue.
                                </div>
