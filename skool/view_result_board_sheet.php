...
$PageTitle=" View Result Broad Sheet";
...
<a style="background:#1b3058; font-size:12px; padding:10px; color:#fff;" href="<?php echo SKOOL_URL; ?>class_teacher_broadsheet_pdf.php?randomid=<?php echo $_GET['randomid']; ?>&assesment=<?php echo $pdfAssesment; ?>&session=<?php echo $_POST['session']; ?>&term_id=<?php echo $_POST['term_id']; ?>" class="printer_pdf" target="blank">
	Print Broad Sheet
</a>
