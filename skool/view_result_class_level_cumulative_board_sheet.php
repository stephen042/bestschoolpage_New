...
$classDetail=$db->getRow("select * from school_class where randomid='".$_GET['randomid']
."' and create_by_userid='".$create_by_userid."'");


$validate = new validation();
$pageTitle = 'Class level Cumulative Board Sheet';
$Filename = 'view_result_class_level_cumulative_board_sheet.php';
?>
<!DOCTYPE html>
<html>
<head>
...
<button type="button" class="gwt-Button">Print Cumulative Broad Sheet</button></td>
<td align="left" style="vertical-align: top;">
...
<label for="gwt-uid-8">Exams(40%)</label></span>
                            </td>
            ...
            <tr>
                <td>
                    <div class="boldInfoLabel">
                        SESSION:<?php echo $db->getVal("select session from school_session where id= '".$classDetail['session_id']."'");
            ...
            <tr>
                <td>
                    <div class="infoLabel">
                        Class: <?php echo $db->getVal("select name from school_class where id ='" . $classDetail['class_id'] . "' ");
            ...
            <table  class="table table-striped table-bordered">
                ...
                <tr>
                    ...
                    <th>Position</th>
                    <th>Final Grade</th>
					<?php  $schoolClassDetail=$db->getRows("select * from school_subject where create_by_userid='".$create_by_userid."' ");
...
<?php } ?>
                ...
                <?php
                $aryList = $db->getRows("select * from input_score_subject_teacher where class_id = '" .$classDetail['class_id']. "' and subject_id='".$classDetail['id']."'  and create_by_userid='".$create_by_userid."'");
                ...
                $aryPgAct["id"] = $iList['id'];
                    $aryStudent = $db->getRow("select * from manage_student where id = '" .$iList['student_id']. "'  and create_by_userid='".$create_by_userid."'");
                ?>
                ...
                <tr class="flexTable-OddRow">
                   ...
                   <?php  $scoreDetail=$db->getRows("select * from input_score_subject_teacher where subject_id='".$classDetail['id']."' and student_id='".$iList['student_id']."'  and create_by_userid='".$create_by_userid."'"); 
				  
				   
				   foreach ($scoreDetail as $iListscoredetail)  { ?>
                    <td>
                        <div class="gwt-Label" style="width: 100%;">
             <?php echo $total=$iListscoredetail['ca_1']+$iListscoredetail['ca_2']+$iListscoredetail['exams']; ?>
                        </div>
                    </td>
				   <?php } ?>
