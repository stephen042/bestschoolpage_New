                ...
                <table cellspacing="5" cellpadding="0">
                  <tbody>
                    <tr>
                      ...
                      <a href="<?php echo SKOOL_URL; ?>cummulative_broad_sheet_pfd.php?randomid=<?php echo $_GET['randomid']; ?>&session=<?php echo $_POST['session']; ?>&term_id=<?php echo $_POST['term_id']; ?>" class="gwt-Button" style="background: #1b3058;color: #fff; padding: 10px; font-size: 12px;" target="blank">Print Cumulative Broad Sheet</a></td>
                    </tr>
                  </tbody>
                </table>
                <div class="zasw1">
