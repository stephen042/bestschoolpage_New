...
{ 
	...
	$validate->addRule($_POST['date'],'','Date',true);
	...
	if($validate->validate() && count($stat)==0)
	{
		...
		$iLastId=$db->getVal("select id from school_upcoming_event order by id desc")+1;		
		...
		$aryData=array(	
			...
			$flgIn1 = $db->insertAry("school_upcoming_event",$aryData);
...
{ 
	...
	{ 
		...
		$aryData=array(	
			...
			$flgIn = $db->updateAry("school_upcoming_event", $aryData , "where randomid='".$_GET['randomid']."' ");
...
{
	$flgIn1 = $db->delete("school_upcoming_event","where randomid='".$_GET['randomid']."' ");			
...
<div class="content">
	<div class="container">
        ...
        <div class="row">
			...
			$aryDetail=$db->getRow("select * from  school_upcoming_event where randomid='".$_GET['randomid']."'");	
			?>
            <div class="card-box">
			<form role="form" action="" method="post" enctype="multipart/form-data">
			<section>
				...
				<div class="form-group clearfix">
					<label class="col-lg-2 control-label " for="userName">Date </label>
					<div class="col-lg-10">
						<input type="text" class="form-control" name="date" value="<?php echo $aryDetail['date']; ?>">
					</div>
				</div>
			...
			$GetEmailId=$db->getRow("select * from  school_upcoming_event where randomid='".$_GET['randomid']."'");
			?>
            <div class="card-box">
            <section>
				<div class="form-group clearfix">
            ...
            <table id="datatable" class="table table-striped table-bordered">
              ...
              <tbody>
                <?php
		$aryList=$db->getRows("select * from school_upcoming_event where create_by_userid='".$create_by_userid."' order by id desc");
