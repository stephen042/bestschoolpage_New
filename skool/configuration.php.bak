	...
	if($_POST['is_pos']=='')			{ $is_pos 				= '0'; 		} 		else { 	$is_pos 				= '1'; } 
        ...
        if($iSchoolPDFsetting!='')
        {
			$aryData = array(	'is_grade' 					=>	$is_grade,
				...
				$flgIn2 = $db->updateAry("school_pdfsetting", $aryData , "where id='".$iSchoolPDFsetting."'");
		}
		else
		{
...
<div class="container">
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<ol class="breadcrumb">
				<li class="dippi">
					<a href="<?php echo $iClassName; ?>">Create session, term, sections, classes and subjects</a>
				</li>
			</ol>
			<?php echo msg($stat);?>
		</div>
					...
					<div class="card">
						<ul class="nav nav-tabs" role="tablist">
							<li role="presentation" class="<?php if($_GET['action']=='' || $_GET['action']=='configuration') { echo "active"; } ?>">
								<a href="<?php echo $Filename; ?>?action=configuration">
							...
							<li role="presentation" class="<?php if($_GET['action']=='session') { echo "active"; } ?>">
								<a href="<?php echo $Filename; ?>?action=session">
							...
							<li role="presentation" class="<?php if($_GET['action']=='term') { echo "active"; } ?>">
								<a href="<?php echo $Filename; ?>?action=term">
									...
									?>
                                        <tr>
											...
											<td>
												...
												<?php } else { ?>
												<a href="<?php echo $FileName; ?>?action=session&randomid=<?php echo $iList['randomid']; ?>" class="table-action-btn">
                                                    <i class="fa fa-pencil"></i> 
												</a>
												<?php } ?>
											</td>
											<td>
												<a href="javascript:del('<?php echo $FileName; ?>?action=deletesession&randomid=<?php echo $iList['randomid']; ?>')" class="table-action-btn"> 
									...
									?>
                                        <tr>
											...
											<td>
												...
												<?php } else { ?>
												<a href="<?php echo $FileName; ?>?action=term&randomid=<?php echo $iList['randomid']; ?>" class="table-action-btn">
                                                    <i class="fa fa-pencil"></i> 
												</a>
												<?php } ?>
											</td>
											<td>
												<a href="javascript:del('<?php echo $FileName; ?>?action=deleteterm&randomid=<?php echo $iList['randomid']; ?>')" class="table-action-btn"> 
													<i class="fa fa-times"></i> 
												</a>
											</td>
                                        </tr>
									...
									?>
                                        <tr>
											...
											<td>
												...
												<?php } else { ?>
												<a href="<?php echo $FileName; ?>?action=section&randomid=<?php echo $iList['randomid']; ?>" class="table-action-btn">
                                                    <i class="fa fa-pencil"></i> 
												</a>
												<?php } ?>
											</td>
											<td>
												<a href="javascript:del('<?php echo $FileName; ?>?action=delete_section&randomid=<?php echo $iList['randomid']; ?>')" class="table-action-btn"> 
													<i class="fa fa-times"></i> 
												</a>
											</td>
								...
								<form action="" method="POST">
									...
									?>
										...
										<td>
												...
												<?php } else { ?>
												<a href="<?php echo $FileName; ?>?action=class&randomid=<?php echo $iList['randomid']; ?>" class="table-action-btn">
                                                    <i class="fa fa-pencil"></i> 
												</a>
												<?php } ?>
										</td>
											...
											<td>
												<a href="javascript:del('<?php echo $FileName; ?>?action=delete_class&randomid=<?php echo $iList['randomid']; ?>')" class="table-action-btn"> 
													<i class="fa fa-times"></i> 
												</a>
											</td>
                                             <td><a href="<?php echo $FileName; ?>?action=pdfsetting&randomid=<?php echo $iList['id']; ?>" class="table-action-btn">
									...
									?>
                                        <tr>
											...
											<td>
												...
												<?php } else { ?>
												<a href="<?php echo $FileName; ?>?action=subject&randomid=<?php echo $iList['randomid']; ?>" class="table-action-btn">
                                                    <i class="fa fa-pencil"></i> 
												</a>
												<?php } ?>
											</td>
											<td>
												<a href="javascript:del('<?php echo $FileName; ?>?action=delete_subject&randomid=<?php echo $iList['randomid']; ?>')" class="table-action-btn"> 
													<i class="fa fa-times"></i> 
												</a>
											</td>
                                        </tr>
