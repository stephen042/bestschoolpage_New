...
// ============================================================================
// PASSWORD GENERATION FUNCTION (Uppercase + Numbers + Symbols)
// ============================================================================
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .action-icon.copy { color: #17a2b8; }
        .action-icon.copy:hover { background: #d1ecf1; }
        ...
        <div class="content">
            <div class="users-container">
                ...
                <div class="page-header">
                    ...
                    <p>View and manage user accounts. Passwords are automatically generated when accounts are created.</p>
                </div>
                                    ...
                                    <tbody>
                                        <?php if (!empty($parents)): ?>
                                            ...
                                            ?>
                                                <tr>
                                                    <td><?= $i++ ?></td>
                                                    <td><?= htmlspecialchars($parentDetail['parent_id'] ?? '') ?></td>
