...
{ 
	if($validate->validate() && count($stat)==0)
	{
		...
		$iLastId=$db->getVal("select id from school_gallery order by id desc")+1;		
		...
		$aryData=array(	
			...
			$flgIn1 = $db->insertAry("school_gallery",$aryData);
...
{ 
	...
	{ 
		...
		$aryData=array(	
			...
			$flgIn = $db->updateAry("school_gallery", $aryData , "where randomid='".$_GET['randomid']."' ");
...
{
	$flgIn1 = $db->delete("school_gallery","where randomid='".$_GET['randomid']."' ");			
...
<div class="content">
	<div class="container">
        ...
        <div class="row">
			...
			$aryDetail=$db->getRow("select * from  school_gallery where randomid='".$_GET['randomid']."'");	
			?>
            <div class="card-box">
			<form role="form" action="" method="post" enctype="multipart/form-data">
			<section>
			...
			$GetEmailId=$db->getRow("select * from  school_gallery where randomid='".$_GET['randomid']."'");
			?>
            <div class="card-box">
            <section>
				<div class="form-group clearfix">
            ...
            <table id="datatable" class="table table-striped table-bordered">
              ...
              <tbody>
                <?php
		$aryList=$db->getRows("select * from school_gallery where create_by_userid='".$create_by_userid."' order by id desc");
