...
$iGetPositionAll=$db->getRows("select * from school_subject where class_id = '" .$iStudent['class']. "' and create_by_userid='".$create_by_userid."'");
...
//--------------------------------------------------------Total Score------------------------------------------------------------------------------------------------------
$subdetaisForToal=$db->getRows("select * from school_subject where class_id = '" .$iStudent['class']. "' and create_by_userid='".$create_by_userid."'");
$tSubtotal=0;
foreach ($subdetaisForToal as $IlistTotal) { 
$tSubtotal++;
foreach($totalAssesment as $Val) 
{ 	
$scoresTotal=$db->getRow("select * from input_score_class_teacher where assesment_id='".$Val."' and student_id='".$iStudent['id']."' and subject_id='".$IlistTotal['id']."' and create_by_userid='".$create_by_userid."'");
...
<table style="width:100%;">
  <tr>
    <td colspan="2" style="width: 120px;"><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <img style="width:100px" src="../uploads/<?php echo $iSchool['logo']; ?>"> </div></td>
    <td colspan="3"><p style="font-size: 25px;color: #2196F3;font-weight: bolder;text-align: center;font-family: sans-serif;margin-bottom: 0;"><?php echo $iSchool['name']; ?></p>
      ...
      <br></td>
    <td colspan="2" style="width: 120px;"><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <?php if($iSchoolPDFsetting['is_profilepic']=='1') { ?>
        <img style="width:150px" src="../uploads/<?php echo $iStudent['picture']; ?>">
        <?php } ?>
      </div></td>
  </tr>
</table>
  ...
  <tbody style="font-family: sans-serif;">
    <tr>
      <td style="width:100%;" ><table style="width:100%;">
          ...
          <tr>
            <?php
$scoreNew=$db->getRow("select * from input_score_class_teacher where assesment_id IN($assesmentIn) and student_id='".$iStudent['id']."'  and create_by_userid='".$create_by_userid."'");
					 ?>
          ...
          <tr>
            ...
            <td style=""><?php echo round(max($getClasAvg),2); ?></td>
            <?php } ?>
            <?php if($iSchoolPDFsetting['is_lowestaverage']=='1') { ?>
            <td style=""><b>Lowest Avg. in Class:</b></td>
            <td style=""><?php echo round(min($getClasAvg),2); ?></td>
            <?php } else {  ?>
            <td style=""></td>
            <td style=""></td>
            <?php } ?>
          ...
          <tr>
            ...
            <td style=""><?php echo $totalOpen=$db->getVal("select count(id) from class_teacher_roll_call where session_id='".$_GET['session']."' and term_id='".$_GET['term_id']."' and class_id='".$iStudent['class']."' and create_by_userid='".$create_by_userid."'"); ?></td>
            <?php } ?>
            ...
            <td style=""><?php 
						...
						$totalPressent= $db->getRows("select * from class_teacher_roll_call where  session_id='".$_GET['session']."' and term_id='".$_GET['term_id']."' and class_id='".$iStudent['class']."' and create_by_userid='".$create_by_userid."'");
  ...
  <tbody style="font-size: 18px;font-weight: bolder;font-family: sans-serif;">
    ...
    <tr style="height: 35px;">
      ...
      <?php $count=0;
			foreach($totalAssesment as $Val) 
			{ 	$count=$count+1;
				$scores=$db->getRow("select * from input_score_class_teacher where assesment_id='".$Val."' and student_id='".$iStudent['id']."' and subject_id='".$Ilist['id']."' and create_by_userid='".$create_by_userid."'");
				?>
	  ...
	  <?php  $gradding=$db->getRow("select grade, description from school_grade where  create_by_userid='".$create_by_userid."' and minimum_number <= ".$grandTotal." and maximum_number >= ".$grandTotal."");
	 		echo $gradding['grade'];
		?></td>
      ...
      <td style="font-weight: 100; text-align: center;  border: 1px solid #000000;  <?php if($iSchoolPDFsetting['is_out']!='1') { echo 'display:none'; }  ?>"><?php echo $outOf=$db->getVal("select count(id) from  manage_student where session='".$_GET['session']."' and term_id='".$_GET['term_id']."' and class='".$iStudent['class']."' and create_by_userid='".$create_by_userid."'"); ?></td>
    ...
    <tr>
      <td style="width:100%;" ><table style="width:100%;">
          ...
          <tr>
            ...
            <td style="padding: 0;vertical-align: baseline;width: 50%;"><table cellspacing="0"; style="width: 95%;">
            ...
            <td style="padding: 0;vertical-align: baseline;width: 50%;"><?php if($iSchoolPDFsetting['is_phycomotor']=='1') { ?>
              <table cellspacing="0"; style="width: 95%;">
                <tbody style="font-size: 16px;font-family: sans-serif;">
                  <tr style="height: 40px;">
                    <td style="  border: 1px solid #000000;"><?php if($iSchoolPDFsetting['title_5']=='') { echo "PSYCHOMOTOR"; } else { echo $iSchoolPDFsetting['title_5']; } ?></td>
                    <td style="  border: 1px solid #000000;text-align: center;">RATING</td>
                  </tr>
                  <?php
      ...
      <td style="width:100%;" ><table style="width:100%;">
          ...
          <tr>
            ...
            <td style=""><?php if($iSchoolPDFsetting['title_3']=='') { echo "Principal's Remarks"; } else { echo $iSchoolPDFsetting['title_3']; } ?>
              :</td>
            <td style=""><?php echo $db->getVal("select comments from principle_remarks where student_id='".$iStudent['id']."'"); ?></td>
            <?php $sign_term=$db->getRow("select nextTerm,sign from  principal_sign_nextTerm where session_id='".$_GET['session']."' and term_id='".$_GET['term_id']."'and class_id='".$iStudent['class']."'  and create_by_userid='".$create_by_userid."'"); ?>
            <td style="width: 90px;"><img  src="../uploads/<?php echo $sign_term['sign']; ?>" style="width: 70px;"></td>
          </tr>
          <tr>
