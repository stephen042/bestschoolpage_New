<?php
// ============================================================================
// PACKAGE PAYMENT STATUS PAGE
// ============================================================================
// Displays payment status after Paystack callback
// ============================================================================
...
if ($statusType === 'success') {
  ...
  $statusMessage = 'Your package purchase has been confirmed and your account has been updated. Redirecting you to your dashboard.';
...
<body class="home page-template page-template-tpl-home page-template-tpl-home-php page page-id-14">
  ...
  <script>
    (function() {
      ...
      <?php if ($statusType === 'success' && !empty($_SESSION['userid'])) { ?>
